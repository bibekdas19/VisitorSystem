...
public class resetOtp {
	 ...
	 String secretKey;
	    ...
	    @Test
	    public void resetOtpwithValidCredentials() throws Exception {
	    ...
	    @Test
	    public void resetOtpwithoutDevice() throws Exception {
	    	 ObjectMapper objectMapper = new ObjectMapper();
	         String email = "vivek@moco.com.np";
	         String requestTimestamp = signatureCreate.generateTimestamp();
	    ...
	    @Test
	    public void resetOtpwithoutUserAgent() throws Exception {
	    	 ObjectMapper objectMapper = new ObjectMapper();
	         String email = "vivek@moco.com.np";
	         String requestTimestamp = signatureCreate.generateTimestamp();
	    ...
	    @Test
	    public void resetOtpWithEmptyLocation() throws Exception {
	    	 ObjectMapper objectMapper = new ObjectMapper();
	         String email = "vivek@moco.com.np";
	         String requestTimestamp = signatureCreate.generateTimestamp();
	    ...
	    @Test
	    public void resetOtpwithInvalidDevice() throws Exception {
	    	 ObjectMapper objectMapper = new ObjectMapper();
	         String email = "vivek@moco.com.np";
	         String requestTimestamp = signatureCreate.generateTimestamp();
	    ...
	    @Test
	    public void resetOtpwithInvalidLocation() throws Exception {
	    	 ObjectMapper objectMapper = new ObjectMapper();
	         String email = "vivek@moco.com.np";
	         String requestTimestamp = signatureCreate.generateTimestamp();
	    ...
	    @Test
	    public void resetOtpwithInvalidUserAgent() throws Exception {
	    	 ObjectMapper objectMapper = new ObjectMapper();
	         String email = "vivek@moco.com.np";
	         String requestTimestamp = signatureCreate.generateTimestamp();
	    ...
	    @Test
	    public void resetOtpwithEmptyEmail() throws Exception {
	    	 ObjectMapper objectMapper = new ObjectMapper();
	         String email = "";
	         String requestTimestamp = signatureCreate.generateTimestamp();
	    ...
	    @Test
	    public void resetOtpwithEmptyTimestamp() throws Exception {
	    	 ObjectMapper objectMapper = new ObjectMapper();
	         String email = "vivek@moco.com.np";
	         //String requestTimestamp = signatureCreate.generateTimestamp();
	    ...
	    @Test
	    public void resetOtpwithNoSignature() throws Exception {
	    	// ObjectMapper objectMapper = new ObjectMapper();
	         String email = "vivek@moco.com.np";
	         String requestTimestamp = signatureCreate.generateTimestamp();
	    ...
	    @Test
	    public void resetOtpwithInvalidTime() throws Exception{
	    	 ObjectMapper objectMapper = new ObjectMapper();
	         String email = "vivek@moco.com.np";
	        // String requestTimestamp = signatureCreate.generateTimestamp();
	    ...
	    @Test
	    public void resetOtpWithInvalidEmailformat() throws Exception{
	    	 ObjectMapper objectMapper = new ObjectMapper();
	    ...
	    @Test
	    public void resetOtpwithDuplicateDevice() throws Exception{
	    	 ObjectMapper objectMapper = new ObjectMapper();
	         String email = "vivek@moco.com.np";
	         String requestTimestamp = signatureCreate.generateTimestamp();
	        ...
	        assertFalse(description.isEmpty(), "Description is empty");
	        assertFalse(code.isEmpty(), "Code is empty");
	        assertEquals(code,"VST_resetOtp_DEVICE");
	        assertEquals(description,"Device already exists.");
	    	
	    }
	    
	    @Test
	    public void resetOtpwithDuplicateEmail() throws Exception {
	    	 ObjectMapper objectMapper = new ObjectMapper();
	         String email = "vivek@moco.com.np";
	         String requestTimestamp = signatureCreate.generateTimestamp();
	        ...
	        assertFalse(description.isEmpty(), "Description is empty");
	        assertFalse(code.isEmpty(), "Code is empty");
	        assertEquals(code,"VST_resetOtp_EMAIL");
