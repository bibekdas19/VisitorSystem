...
public class authenticateWithBio {
	 String secretKey;
	 String AuthToken;
	 String requestDeviceId = "visitor-app-device"; 
	 String input_email = "vivek@moco.com.np";
	 String input_pin = "tzLhMbbV+G/oQrgXvBg34su8wk1rztNBiR3";
...
//                .header("X-GEO-Location", "12,12")
//                .header("X-Device-Id", requestDeviceId)
//                .header("User-Agent", "NepalTravelA..S1.0.0 ios")
//                .contentType("application/json")
//                .body(jsonBody)
//            .when()
//                .post("/authenticate")
...
//	}
	...
	public void AuthenticatewithValidCredentials() throws Exception {
        ...
        String Pin = signatureCreate.encryptAES256(input_pin, secretKey);
        credentials.put("hash", Pin);
